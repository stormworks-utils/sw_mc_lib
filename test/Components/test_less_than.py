...
from sw_mc_lib.Components.less_than import ComponentType, LessThan
...
class TestLessThan(BinopHelper, unittest.TestCase):
    ...
    def test_from_xml(self) -> None:
        ...
        expected: LessThan = LessThan(self.COMPONENT_ID, Position())
    ...
    def test_to_xml(self) -> None:
        elem: LessThan = LessThan(self.COMPONENT_ID, Position(), Input(self.INPUT_1))
