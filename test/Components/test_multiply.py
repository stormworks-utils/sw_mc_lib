...
from sw_mc_lib.Components.Multiply import Multiply, ComponentType
from .test_utils import BinopHelper, Input, Position


class TestMultiply(BinopHelper, unittest.TestCase):
    def __init__(self, *args):
        super().__init__(ComponentType.Multiply.value, *args)
    ...
    def test_from_xml(self) -> None:
        ...
        expected: Multiply = Multiply(self.COMPONENT_ID, Position.empty_pos())
