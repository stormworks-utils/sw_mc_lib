...
from sw_mc_lib.Components.composite_write_number import CompositeWriteNumber
from sw_mc_lib.XMLParser import XMLParserElement

from .test_utils import Position


class TestCompositeWriteNumber(unittest.TestCase):
    ...
    def test_simple(self) -> None:
        ...
        expected: CompositeWriteNumber = CompositeWriteNumber(
            1,
            Position(0, 0),
            1,
            1,
        ...
        self.assertEqual(expected, CompositeWriteNumber.from_xml(elem))
