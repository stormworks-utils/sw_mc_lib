...
from sw_mc_lib.Components.or_ import OR, ComponentType
...
class TestOR(BinopHelper, unittest.TestCase):
    ...
    def test_from_xml(self) -> None:
        ...
        expected: OR = OR(self.COMPONENT_ID, Position())
    ...
    def test_to_xml(self) -> None:
        elem: OR = OR(self.COMPONENT_ID, Position(), Input(self.INPUT_1))
